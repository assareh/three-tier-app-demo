...
docker tag tasky:latest $(terraform output -raw container_registry_url)
docker push $(terraform output -raw container_registry_url)
```

Below copied from: https://github.com/jeffthorne/tasky
